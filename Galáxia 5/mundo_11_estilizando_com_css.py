...
app.layout = html.Main(
    ...
    children = [
        html.Div(children=[
            html.Div(
                html.H1(children='Cotações de Ontem', className='titulos-do-dash'), 
        ...
        html.Div(children=[
            html.Div(
                html.H1(children='Gráfico de Candle', className='titulos-do-dash'), 
                style={'display':'flex', 'justify-content':'center'}),
        ...
        html.Div(children=[
            html.Div(
                html.H1(children='Gráfico de Inflação', className='titulos-do-dash'), 
                style={'display':'flex', 'justify-content':'center'}),
